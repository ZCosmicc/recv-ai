...
export default function LimitModal({ isOpen, onClose, tier }: LimitModalProps) {
            ...
            <div className="bg-white border-4 border-black shadow-neo-lg w-full max-w-md animate-in fade-in zoom-in duration-200">
                <div className="flex justify-between items-center p-4 border-b-4 border-black bg-yellow-100">
                    <h2 className="text-xl font-bold flex items-center gap-2">
                        ...
                        {isGuest ? 'Unlock More Space' : 'Limit Reached'}
                    </h2>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        >
                            {isGuest ? 'Maybe Later' : 'Got it'}
                        </button>
                        {isGuest && (
                            <button
                                onClick={() => {/* Navigate to pricing? For now just close or dummy */ onClose(); alert("Redirect to payment..."); }}
